        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-xl p-4 border border-emerald-200 dark:border-emerald-800">
                    ...
                    <p className="text-2xl font-bold text-emerald-800 dark:text-emerald-300">{totalCompleted.toFixed(1)}h</p>
                </div>
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 rounded-xl p-4 border border-amber-200 dark:border-amber-800">
                    ...
                    <p className="text-2xl font-bold text-amber-800 dark:text-amber-300">{totalRemaining.toFixed(1)}h</p>
                </div>
                    ...
                    {categories.map((ue) => {
                        ...
                        return (
                            <div
                                ...
                                className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200/60 dark:border-slate-700 cursor-pointer hover:shadow-lg hover:scale-[1.01] active:scale-[0.99] transition-all group"
                            >
                                <div className="flex flex-col gap-2 mb-3">
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-slate-500 dark:text-slate-400">{ue.subjects.length} matières</span>
                                        <span className="font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/40 px-2 py-1 rounded-md">
            ...
            {selectedCategory && (
                ...
                >
                    <div
                        className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col animate-slideUp"
                    ...
                    >
                        ...
                        <div className="p-5 overflow-y-auto space-y-4">
                            <div className="grid grid-cols-2 gap-3 mb-6">
                                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/40 rounded-xl border border-emerald-100 dark:border-emerald-800 text-center">
                                    <p className="text-emerald-700 dark:text-emerald-400 text-xs font-bold uppercase mb-1">Effectuées</p>
                                    <p className="text-2xl font-bold text-emerald-800 dark:text-emerald-300">{selectedCategory.hoursCompleted.toFixed(1)}h</p>
                                </div>
                                <div className="p-4 bg-amber-50 dark:bg-amber-900/40 rounded-xl border border-amber-100 dark:border-amber-800 text-center">
                                    <p className="text-amber-700 dark:text-amber-400 text-xs font-bold uppercase mb-1">Restantes</p>
                                    <p className="text-2xl font-bold text-amber-800 dark:text-amber-300">{selectedCategory.hoursRemaining.toFixed(1)}h</p>
                                </div>
                            </div>

                            <h4 className="font-bold text-slate-800 dark:text-slate-100 border-b border-slate-100 dark:border-slate-700 pb-2">Détail par matière</h4>
                            ...
                            <div className="space-y-3">
                                {selectedCategory.subjects.map(subject => {
                                    ...
                                    return (
                                        <div key={subject.id} className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-3 border border-slate-100 dark:border-slate-600">
                                            <div className="flex justify-between items-start mb-2">
                                                <span className="font-medium text-slate-800 dark:text-slate-100 text-sm">{subject.nom}</span>
                                                <span className="text-xs font-bold px-2 py-0.5 bg-white dark:bg-slate-600 rounded border border-slate-200 dark:border-slate-500 text-slate-600 dark:text-slate-300">
                                            ...
                                            <div className="flex justify-between text-xs text-slate-500 dark:text-slate-400">
                                                ...
                                                <span className={subject.hoursRemaining > 0 ? "text-amber-600 dark:text-amber-400 font-medium" : "text-emerald-600 dark:text-emerald-400 font-medium"}>
                                            ...
                                            {subject.nextEvent && (
                                                <Link
                                                    ...
                                                    className="mt-2 flex items-center gap-1.5 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 p-1.5 rounded-lg transition-colors w-full justify-center border border-indigo-100 dark:border-indigo-800"
                                                >
